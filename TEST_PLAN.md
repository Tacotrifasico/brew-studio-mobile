...
- Cuenta: estado seguro sin configuración, login GoTrue, registro con sesión inmediata o confirmación de correo pendiente, reenvío de confirmación, recuperación con respuesta que no revela si el correo existe, sesión vencida sin red conservada y refresh rechazado limpiado: casos críticos ejecutados en el verificador + XCTest compilado.
