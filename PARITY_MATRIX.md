...
| Cuenta | Registro, login, sesión, cierre y recuperación | Supabase Android | Implementado sin validar | Keychain + contrato GoTrue | Implementado sin validar | Contrato HTTP y estado sin configuración compilados | URL/anon key para integración real | Sesión recuperable y aislada | Implementado sin validar |
| Sincronización | Offline → Supabase | Repositorios Android | Parcial | Outbox Core Data + REST preparado | N/A | Reintento, deduplicación y conflicto ejecutados | URL/anon key para integración real | Reintentos, mapeo completo y conflictos deterministas | Parcial |
