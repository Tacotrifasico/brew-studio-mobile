...
enum CoreSyncSchema {
    static let descriptors: [SyncEntityDescriptor] = [
        ...
        .init(entityName: "RecipeRecord", table: "recipes", fields: [f("name"),f("recipeKind","recipe_kind"),f("intention"),f("suggestedMethodId","suggested_method_id",.uuid),f("suggestedMethodName","suggested_method_name"),f("isFavorite","is_favorite",.boolean),f("tags"),f("visibility"),f("originalEntityId","original_entity_id",.uuid),f("rootEntityId","root_entity_id",.uuid),f("copyMode","copy_mode")], ownerField: "user_id"),
