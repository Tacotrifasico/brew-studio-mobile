...
- Social: feed público en `shares`, publicación sin correo y con snapshot plano compatible con Android, resumen visible de receta/técnica, lectura de snapshots Android, límite común de 280 caracteres, envío directo con destinatario, buzón/lectura, actividad, Me gusta/guardados, reporte, bloqueo y filtro preventivo: contratos XCTest compilados. Los fallos de carga y publicaciones eliminadas tienen estados explícitos. Copia y variante profundas con UUID nuevos, autor original, publicación fuente, raíz, atribución y modos `IMPORT`/`FORK`: verificador ejecutado.
