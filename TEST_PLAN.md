...
- Social: feed público en `shares`, publicación sin correo y con snapshot plano compatible con Android, lectura de snapshots Android, límite común de 280 caracteres, envío directo con destinatario, buzón/lectura, actividad, Me gusta/guardados, reporte, bloqueo y filtro preventivo: contratos XCTest compilados. Copia y variante profundas con UUID nuevos, atribución y modos `IMPORT`/`FORK`: verificador ejecutado.
